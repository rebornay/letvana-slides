...
<img border="rounded" width="300px" height="auto" src="https://images.unsplash.com/photo-1672490410415-30c8c6c0c68c?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">

<img border="rounded" width="300px" height="auto" src="https://images.unsplash.com/photo-1649770638178-bc86130bb32c?q=80&w=2157&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
...
<img width="80%" src="./assets/Letvana1.jpg" alt="Image from assets" />
...
<img width="80%" src="./assets/Letvana2.jpg" alt="Image from assets" />
...
<script setup>
import myImage from './assets/four.jpg'
</script>

<img :src="myImage" alt="My Image" width="85%" />
...
<script setup>
import myImage from './assets/four2.jpg'
</script>
...
For our primary infrastructure, we would be using **AWS.** <br>
...
```mermaid
flowchart TD
  A[User files dispute] --> B[Transaction flagged]
  B --> C[Notify both parties]
  C --> D[Begin internal investigation]
  D --> E[Valid claim]
  D --> F[Invalid or resolved]
  E --> G[Refund/Reversal]
  F --> H[Release funds]
```
